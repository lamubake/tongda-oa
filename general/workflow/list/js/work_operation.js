...
function check_form(){
	...
	switch(checkType){
		...
		case "export"://代办工作导出
			try{
				var url="data/work_to_export.php";
		...
		case "export_instrust"://工作委托导出
			try{
				var url="data/work_to_export_instrust.php";
				jQuery("#form1").attr("action",url);
				jQuery("#form1").submit();
			}catch(e){
				return false;
		...
		case "export_concern"://关注工作导出
			try{
				var url="data/work_to_export_concern.php";
				jQuery("#form1").attr("action",url);
				jQuery("#form1").submit();
			}catch(e){
				alert(e);
		...
		case "export_pending"://挂起工作导出
			try{
				var url="data/work_to_export_pending.php";
				jQuery("#form1").attr("action",url);
				jQuery("#form1").submit();
			}catch(e){
				alert(e);
		...
		case "export_settles"://办结工作导出
			try{
				var url="data/work_to_export_settles.php";
				jQuery("#form1").attr("action",url);
				jQuery("#form1").submit();
			}catch(e){
				alert(e);
		...
		case "export_data_all"://全部工作导出
			try{
				var url="data/work_to_export_data_all.php";
				jQuery("#form1").attr("action",url);
				jQuery("#form1").submit();
			}catch(e){
				return false;
