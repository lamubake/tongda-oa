        ...
        else
        {
            switch(coltype_array[i]) 
            {
                ...
                case 'select':
                    ...
                    cell_html='<select onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;">';
                    else
                    cell_html='<select>';
                    if(colvalue_array[i]!='')
                    {
                ...
                case 'raw':
                    ...
                    if(row_value!="")
                        cell_html+=" value=\"\"";
                    cell_html+=" readonly class=BigStatic";
                    cell_html+=" style=\"line-height:normal;border-bottom-width:0px; border-left-width:0px; border-top-width:0px; border-right-width:0px;background-color:#fff\"";
                    cell_html+=">";
                    mynewcell.innerHTML=cell_html;
                    break;
                default:
...
function initListView(lv_table_id, default_cols){
