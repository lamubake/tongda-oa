...
jQuery(document).on('click', '.users-add', function() {
    ...
    if (prcs_next) {
        ...
        urlStr = "../turn/user_select/?FLOW_ID=" + flow_id + "&RUN_ID=" + run_id + "&PRCS_ID=" + prcs_id + "&PRCS_ID_NEXT=" + prcs_next_id + "&LINE_COUNT=" + prcs_next + "&PRCS_BACK=" + prcs_back + "&PRCS_KEY_ID=" + prcs_key_id;
        loc_x = 220;
        loc_y = 200;
        if (is_ie) {
