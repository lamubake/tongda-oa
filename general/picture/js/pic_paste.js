...
function do_rename(SUB_DIR,PIC_PATH)
{
   ...
   if(temp_sub_dir=="")
     URL = "rename_action.php?SUB_DIR="+SUB_DIR+"&PIC_PATH="+PIC_PATH+"&PIC_NAME="+escape(PIC_NAME);
   else
   	 URL = "rename_action.php?SUB_DIR="+temp_sub_dir+"&PIC_PATH="+PIC_PATH+"&PIC_NAME="+escape(PIC_NAME);
