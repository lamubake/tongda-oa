...
//							}
							jQuery('#form_list1').find('table').append('<tr form_id='+jsonData[one][key].form_id+'><td><span class="icon16-pencil-content">'+jsonData[one][key].form_name+'</span></td><td><a class="form_ahref" href="javascript:form_edit('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_64+'</a><a class="form_ahref" href="javascript:form_smart('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_65+'</a><a class="form_ahref" href="javascript:form_preview('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_66+'</a><a class="form_ahref" href="javascript:form_import('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_67+'</a><a class="form_ahref" href="javascript:form_export('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_68+'</a><a class="form_ahref" href="javascript:form_version('+jsonData[one][key].form_id+')">'+td_lang.general.workflow.msg_69+'</a>'+del_flag+'</td></tr>');		  
							J++;
						}
					}
					else //图形视图
