...
function back_ok()
{
    ...
    var back_data = 'flow_id=' + back_flow_id + '&run_name=' + back_run_name + '&flow_prcs=' + back_flow_prcs + '&prcs_id=' + back_prcs_id + '&prcs_key_id=' + back_prcs_key_id + '&run_id=' + back_run_id + '&back_counter_singn=' + jQuery('#back_counter_singn').val() + '&allow_back=' + jQuery('#allow_back').val()
...
//工作催办
function reminders(run_id,flow_id,run_name,user_id)
{
...
function reminders_do(){
    ...
    jQuery.get("/module/workflow/engine/flow_reminders.php",{"RUN_ID":run_id,"FLOW_ID":flow_id,"USER_ID":user_id,"CONTENT":content},function(data)
    {
